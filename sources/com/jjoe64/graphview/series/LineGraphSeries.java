...
public class LineGraphSeries<E extends DataPointInterface> extends BaseSeries<E> {
    ...
    public void draw(GraphView graphView, Canvas canvas, boolean isSecondScale) {
        ...
        Iterator<E> values = getValues(lastEndY2, maxX);
        ...
        while (true) {
            ...
            if (i > 0) {
                ...
                if (skipDraw || Float.isNaN(startY) || Float.isNaN(endY)) {
                    ...
                    if (!isOverdrawEndPoint) {
                        if (this.mStyles.drawDataPoints) {
                            paint3 = paint4;
                            Paint.Style prevStyle = paint3.getStyle();
                    ...
                    if (first_X < graphLeft || first_Y > graphTop + graphHeight) {
                        ...
                        if (this.mAnimated) {
                            ...
                            if (((double) timeFactor2) <= 1.0d) {
                                first_X = ((first_X - graphWidth3) * factor2) + graphWidth3;
                                ViewCompat.postInvalidateOnAnimation(graphView);
                            } else {
                        ...
                        Paint.Style prevStyle2 = paint2.getStyle();
                ...
                lastAnimationReferenceX = graphWidth3;
                double d23 = x;
                double d24 = y;
        ...
        float lastAnimationReferenceX5 = graphTop2;
        ...
        if (lastUsedEndY != ((double) (graphHeight + lastAnimationReferenceX5))) {
            this.mPathBackground.lineTo((float) lastUsedEndX, graphHeight + lastAnimationReferenceX5);
        }
        float firstX2 = firstX;
        this.mPathBackground.lineTo(firstX2, graphHeight + lastAnimationReferenceX5);
        float firstY2 = firstY;
        if (firstY2 != graphHeight + lastAnimationReferenceX5) {
            this.mPathBackground.lineTo(firstX2, firstY2);
        }
    ...
    public void setThickness(int thickness) {
        int unused = this.mStyles.thickness = thickness;
    }
    ...
    public void setDrawBackground(boolean drawBackground) {
        boolean unused = this.mStyles.drawBackground = drawBackground;
    }
    ...
    public void setDrawDataPoints(boolean drawDataPoints) {
        boolean unused = this.mStyles.drawDataPoints = drawDataPoints;
    }
    ...
    public void setDataPointsRadius(float dataPointsRadius) {
        float unused = this.mStyles.dataPointsRadius = dataPointsRadius;
    }
    ...
    public void setBackgroundColor(int backgroundColor) {
        int unused = this.mStyles.backgroundColor = backgroundColor;
    }
    ...
    public void drawSelection(GraphView graphView, Canvas canvas, boolean b, DataPointInterface value) {
        ...
        double spanXPixel = (double) graphView.getGraphContentWidth();
        ...
        double pointX = (((value.getX() - graphView.getViewport().getMinX(false)) * spanXPixel) / spanX) + ((double) graphView.getGraphContentLeft());
        double pointY = (((double) graphView.getGraphContentTop()) + spanYPixel) - (((value.getY() - graphView.getViewport().getMinY(false)) * spanYPixel) / spanY);
        double d = spanX;
        canvas2.drawCircle((float) pointX, (float) pointY, 30.0f, this.mSelectionPaint);
        Paint.Style prevStyle = this.mPaint.getStyle();
