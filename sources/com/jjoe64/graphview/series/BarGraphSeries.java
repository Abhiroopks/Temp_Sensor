...
public class BarGraphSeries<E extends DataPointInterface> extends BaseSeries<E> {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r15v19, resolved type: java.lang.Double} */
    ...
    public void draw(com.jjoe64.graphview.GraphView r97, android.graphics.Canvas r98, boolean r99) {
        ...
        L_0x0266:
            ...
            double r3 = r3 * r7
            double r7 = r64 - r3
            android.support.p000v4.view.ViewCompat.postInvalidateOnAnimation(r97)
        L_0x028a:
            r81 = r7
            goto L_0x029a
        L_0x028d:
    ...
    public E findDataPoint(float x, float y) {
        for (Map.Entry<RectD, E> entry : this.mDataPoints.entrySet()) {
            if (((double) x) >= entry.getKey().left && ((double) x) <= entry.getKey().right && ((double) y) >= entry.getKey().top && ((double) y) <= entry.getKey().bottom) {
