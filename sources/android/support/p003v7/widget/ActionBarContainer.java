...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0257R.styleable.ActionBar);
        this.mBackground = a.getDrawable(C0257R.styleable.ActionBar_background);
        this.mStackedBackground = a.getDrawable(C0257R.styleable.ActionBar_backgroundStacked);
        this.mHeight = a.getDimensionPixelSize(C0257R.styleable.ActionBar_height, -1);
        if (getId() == C0257R.C0259id.split_action_bar) {
            this.mIsSplit = true;
            this.mSplitBackground = a.getDrawable(C0257R.styleable.ActionBar_backgroundSplit);
        }
        a.recycle();
        boolean z = false;
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C0257R.C0259id.action_bar);
        this.mContextView = findViewById(C0257R.C0259id.action_context_bar);
    }
