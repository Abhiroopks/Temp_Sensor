...
public class FontResourcesParserCompat {
    ...
    private static FontFileResourceEntry readFont(XmlPullParser parser, Resources resources) throws XmlPullParserException, IOException {
        ...
        int weight = array.getInt(array.hasValue(C0024R.styleable.FontFamilyFont_fontWeight) ? C0024R.styleable.FontFamilyFont_fontWeight : C0024R.styleable.FontFamilyFont_android_fontWeight, NORMAL_WEIGHT);
        boolean z = true;
        if (1 != array.getInt(array.hasValue(C0024R.styleable.FontFamilyFont_fontStyle) ? C0024R.styleable.FontFamilyFont_fontStyle : C0024R.styleable.FontFamilyFont_android_fontStyle, 0)) {
            z = false;
        }
        boolean isItalic = z;
        int resourceAttr = array.hasValue(C0024R.styleable.FontFamilyFont_font) ? C0024R.styleable.FontFamilyFont_font : C0024R.styleable.FontFamilyFont_android_font;
