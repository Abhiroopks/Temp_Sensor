...
public class NotificationCompat {
    ...
    public static class MediaStyle extends NotificationCompat.Style {
        ...
        public RemoteViews generateContentView() {
            ...
            view.removeAllViews(C0055R.C0057id.media_actions);
            if (numActionsInCompact > 0) {
                for (int i = 0; i < numActionsInCompact; i++) {
                    ...
                    view.addView(C0055R.C0057id.media_actions, generateMediaActionButton(this.mBuilder.mActions.get(this.mActionsToShowInCompact[i])));
                }
            }
            if (this.mShowCancelButton) {
                view.setViewVisibility(C0055R.C0057id.end_padder, 8);
                view.setViewVisibility(C0055R.C0057id.cancel_action, 0);
                view.setOnClickPendingIntent(C0055R.C0057id.cancel_action, this.mCancelButtonIntent);
                view.setInt(C0055R.C0057id.cancel_action, "setAlpha", this.mBuilder.mContext.getResources().getInteger(C0055R.integer.cancel_button_image_alpha));
            } else {
                view.setViewVisibility(C0055R.C0057id.end_padder, 0);
                view.setViewVisibility(C0055R.C0057id.cancel_action, 8);
            }
            return view;
        }
        ...
        private RemoteViews generateMediaActionButton(NotificationCompat.Action action) {
            ...
            button.setImageViewResource(C0055R.C0057id.action0, action.getIcon());
            if (!tombstone) {
                button.setOnClickPendingIntent(C0055R.C0057id.action0, action.getActionIntent());
            }
            if (Build.VERSION.SDK_INT >= 15) {
                button.setContentDescription(C0055R.C0057id.action0, action.getTitle());
            }
            return button;
        }
        ...
        public RemoteViews generateBigContentView() {
            ...
            big.removeAllViews(C0055R.C0057id.media_actions);
            if (actionCount > 0) {
                for (int i = 0; i < actionCount; i++) {
                    big.addView(C0055R.C0057id.media_actions, generateMediaActionButton(this.mBuilder.mActions.get(i)));
                }
            }
            if (this.mShowCancelButton != 0) {
                big.setViewVisibility(C0055R.C0057id.cancel_action, 0);
                big.setInt(C0055R.C0057id.cancel_action, "setAlpha", this.mBuilder.mContext.getResources().getInteger(C0055R.integer.cancel_button_image_alpha));
                big.setOnClickPendingIntent(C0055R.C0057id.cancel_action, this.mCancelButtonIntent);
            } else {
                big.setViewVisibility(C0055R.C0057id.cancel_action, 8);
            }
            return big;
        }
    ...
    public static class DecoratedMediaCustomViewStyle extends MediaStyle {
        ...
        private void setBackgroundColor(RemoteViews views) {
            ...
            views.setInt(C0055R.C0057id.status_bar_latest_event_content, "setBackgroundColor", color);
        }
    }
}
